...
class PogostickV0Env(gym.Env):
    ...
    def __init__(self, env=None):
        # PogostickV0Env attributes
        self.env_id = 'NovelGridworld-Pogostick-v0'
        ...
        self.items_quantity = {'crafting_table': 1, 'stick': 4, 'plank': 2, 'tree_log': 2}
    ...
    def step(self, action_id):
        ...
        if action_id == self.actions_id['Forward']:
            ...
            if self.block_in_front_str not in self.unbreakable_items:
                ...
                if self.block_in_front_str in ['stick', 'plank']:
