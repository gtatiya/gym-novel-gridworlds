...
class BowV0Env(gym.Env):
    ...
    def __init__(self, env=None):
        ...
        # Action Space
        self.action_str = {0: 'Forward', 1: 'Left', 2: 'Right', 3: 'Break', 4: 'Extract_string'}
